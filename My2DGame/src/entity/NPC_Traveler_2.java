...
public class NPC_Traveler_2 extends NPC_Traveler_Template {
	...
	public void setDialogue() {
		...
		dialogues[1][4] = "The dungeon, Cyprius! I found it!";
		dialogues[1][5] = "By the saints! Well, Titus, show me!\nShow me!";
		
		dialogues[2][0] = "Well... I thought for sure there was\na dungeon here.";
		dialogues[2][1] = "I'm never trusting that shopowner again!"; 
		dialogues[2][2] = "All he's good for is that nifty\nBoomerang he sells!";
		dialogues[2][3] = "I really wish I had the money for it.\nOr, at least a Shovel to find the money...";
		
		dialogues[3][0] = "Hey! You have a shovel!\nCan it really dig up burried treasure?";
	}
